...
public class Branch<T extends Comparable<T>> extends Tree<T>{
  ...
  public  boolean contains(T x){
    ...
    /* Per fare i confronti usiamo il metodo compareTo(), in modo da avere un confronto generale per tutti i T (che implementano l'interfaccia Comparable<T> e che quindi hanno un metodo compareTo()).
    */
    if (c==0) //x=elem
     return true;
    else if (c<0) //x<elem
