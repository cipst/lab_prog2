...
public class Branch extends Tree {
  ...
  /* Usa la RICERCA BINARIA, in media richiede tempo log_2(n) dove n = numero dei nodi. */
  ...
  /** Inseriamo x preservando l'invariante "albero di ricerca": dunque x va inserito a sinistra se e' piu' piccolo della radice e a destra se e' piu' grande */
    if (x < elem)
      left = left.insert(x); 
